...
def setup_mrp_desktop_and_sidebar():
    ...
    if not frappe.db.exists("Workspace Sidebar", "ERPZ MRP"):
        ...
        sb.append("items", {"label": "Painel de Planejamento MRP", "link_to": "mrp_workbench", "link_type": "Page", "type": "Link", "idx": 1})
        ...
        # Update sidebar title and app
        frappe.db.set_value("Workspace Sidebar", "ERPZ MRP", {
            "app": "erpz_mrp",
            "header_icon": "project",
            "standard": 1
        })
