...
def setup_mrp_desktop_and_sidebar():
    ...
    if not frappe.db.exists("Workspace Sidebar", "ERPZ MRP"):
        ...
        sb.append("items", {"label": "Sugestões de Abastecimento", "link_to": "MRP Result", "link_type": "DocType", "type": "Link", "child": 1, "icon": "check", "idx": 4})
        ...
        sb.append("items", {"label": "Auditoria e Logs", "link_to": "MRP Log", "link_type": "DocType", "type": "Link", "child": 1, "icon": "info", "idx": 8})
