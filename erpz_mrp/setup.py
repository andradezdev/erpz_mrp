...
def setup_mrp_desktop_and_sidebar():
    ...
    if not frappe.db.exists("Workspace Sidebar", "ERPZ MRP"):
        ...
        sb.append("items", {"label": "Sugestões de Abastecimento", "link_to": "MRP Result", "link_type": "DocType", "type": "Link", "child": 1, "icon": "check-circle", "idx": 4})
        sb.append("items", {"label": "Linha do Tempo de Saldos", "link_to": "MRP Timeline", "link_type": "DocType", "type": "Link", "child": 1, "icon": "chart", "idx": 5})
        sb.append("items", {"label": "Rastreabilidade de Demandas", "link_to": "MRP Traceability", "link_type": "DocType", "type": "Link", "child": 1, "icon": "git-branch", "idx": 6})
        sb.append("items", {"label": "Documentos Efetivados", "link_to": "MRP Executed Document", "link_type": "DocType", "type": "Link", "child": 1, "icon": "file-text", "idx": 7})
        sb.append("items", {"label": "Auditoria e Logs", "link_to": "MRP Log", "link_type": "DocType", "type": "Link", "child": 1, "icon": "alert-circle", "idx": 8})
        sb.append("items", {"label": "Cadastros e Parâmetros", "type": "Section Break", "icon": "settings", "idx": 9})
        sb.append("items", {"label": "Parâmetros do MRP", "link_to": "MRP Settings", "link_type": "DocType", "type": "Link", "child": 1, "icon": "setting", "idx": 10})
        sb.append("items", {"label": "Grupos de Empresas Multiempresa", "link_to": "MRP Company Group", "link_type": "DocType", "type": "Link", "child": 1, "icon": "organization", "idx": 11})
        sb.append("items", {"label": "Lead Time entre Empresas", "link_to": "MRP Inter Company Lead Time", "link_type": "DocType", "type": "Link", "child": 1, "icon": "truck", "idx": 12})
